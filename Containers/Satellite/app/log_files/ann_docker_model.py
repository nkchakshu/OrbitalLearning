...
history = model.fit(X_train, y_train.values, epochs=20, validation_data=(X_test, y_test.values))
print(max(history.history['loss']))

# Save model objects - predictor and scaler object
model.save('/model_zoo/planet_check.h5')
joblib.dump(sc, '/model_zoo/scaler.joblib')
